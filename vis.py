...
async def main():
    ...
    st.markdown(
        ...
        data. And to deploy the algorithm and automatise the whole process to continuously update the database and 
        increase the algorithm ability to predict .
        
        The previous steps in this project were made with different teams. See individual repositories for more 
